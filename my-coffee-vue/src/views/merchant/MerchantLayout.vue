          ...
          <div class="header-right">
            ...
            <el-dropdown @command="handleCommand">
              <div class="user-info">
                ...
                <span class="username">{{ userStore.userInfo?.username || '商家' }}</span>
...
import { 
  DataAnalysis, Goods, ShoppingCart, ChatDotRound, Setting,
  Expand, Fold, HomeFilled, User, ArrowDown, SwitchButton
...
.el-menu-item.is-active {
  background: linear-gradient(90deg, #d2691e 0%, #8b4513 100%) !important;
...
/* 滚动条样式 */
.merchant-main::-webkit-scrollbar {
  width: 6px;
}

.merchant-main::-webkit-scrollbar-thumb {
  background: #dcdfe6;
  border-radius: 3px;
}

.merchant-main::-webkit-scrollbar-thumb:hover {
  background: #c0c4cc;
}
</style>
